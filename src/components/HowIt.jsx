          ...
          <Row className=" align-items-center justify-content-center justify-content-lg-start">
            ...
            <Col md="7" className="pt-4 pt-md-0">
              <div data-aos="fade-up-left">
                <p className=" ff_gilroy fw-bold fs_xl tx_neutral tc_danger text-center text-md-start">
                  How it works
                </p>
                <p className=" ff_gilroy fw-bold fs_4xl tx_secondary text-light text-center text-md-start">
